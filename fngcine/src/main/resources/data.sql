...
insert into orders (id, delivery_address, order_date, receiver, total_price, delivery_id, user_id) values (1, '17 avenue des fleurs, 75001 Paris', '2021-11-05', 'Mme Jim', 22.5, 1, 2);
insert into orders (id, delivery_address, order_date, receiver, total_price, delivery_id, user_id) values (2, '3 bis rue du soleil, 13002 Marseille', '2021-10-24', 'Mme Jim', 26.5, 1, 3);
insert into orders (id, delivery_address, order_date, receiver, total_price, delivery_id, user_id) values (3, '67 rue des loups, 29200 Brest', '2021-01-07', 'Chloé', 18.5, 1, 4);
insert into orders (id, delivery_address, order_date, receiver, total_price, delivery_id, user_id) values (4, '24 boulevard des roses, 93100 Montreuil', '2021-05-15', 'Bob', 67.5, 2, 5);
insert into orders (id, delivery_address, order_date, receiver, total_price, delivery_id, user_id) values (5, '4 place du Général, 67000 Strasbourg', '2021-02-12', 'Mr Biagini', 19.5, 2, 2);

insert into order_detail (id, price_by_qty, product_id, quantity) values (1, 20, 1, 2);
insert into order_detail (id, price_by_qty, product_id, quantity) values (2, 24, 1, 1);
insert into order_detail (id, price_by_qty, product_id, quantity) values (3, 16, 2, 1);
insert into order_detail (id, price_by_qty, product_id, quantity) values (4, 60, 4, 2);
insert into order_detail (id, price_by_qty, product_id, quantity) values (5, 12, 8, 5);
